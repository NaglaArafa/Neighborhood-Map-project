...
self.jsonCall = function() {
    $.getJSON("./locations.json", function(data) {
        ...
        for (var i = 0; i < locations.length; i++) {
            ...
            self.setMarker(position, title, id, venueID);
        }
    }).fail(function() {
...
//create new marker
self.setMarker = function(position, title, id, venueID) {
...
self.populateInfoWindow = function(marker, infowindow) {
    ...
    if (infowindow.marker != marker) {
        ...
        self.callFourSquareApi(marker.venueID, infowindow);
        map.setZoom(13);
...
self.callFourSquareApi = function(venueID, infowindow) {
